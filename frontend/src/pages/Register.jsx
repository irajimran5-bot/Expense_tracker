 ...
 return (
  <div className="min-h-screen bg-slate-50 text-slate-900 flex items-center justify-center p-4">
    <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-slate-200">
      <h2 className="text-3xl font-bold text-center text-violet-600 mb-2">Create Account</h2>
      <p className="text-slate-500 text-center text-sm mb-6">Start managing your personal finance</p>

      {error && (
        <div className="bg-rose-500/10 border border-rose-500/50 text-rose-500 text-sm p-3 rounded-lg mb-4 text-center">
          {error}
        </div>
      )}
