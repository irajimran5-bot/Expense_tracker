    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e1b4b] to-[#0f172a] text-slate-100 flex items-center justify-center p-4 relative overflow-hidden selection:bg-cyan-400 selection:text-slate-900">
      ...
      <div className="w-full max-w-md bg-slate-900/40 backdrop-blur-2xl p-8 rounded-3xl shadow-2xl border border-cyan-400/30 relative z-10">
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white via-cyan-100 to-cyan-300 tracking-wide">WELCOME BACK</h2>
          <p className="text-cyan-200/80 text-xs mt-1 uppercase tracking-wider font-medium">Log in to track your expenses</p>
        </div>
        ...
        <p className="text-cyan-200/80 text-xs text-center mt-6">
          Don't have an account? <Link to="/register" className="text-cyan-300 hover:text-white font-bold underline underline-offset-4">Register</Link>
        </p>
      </div>
    </div>
  );
